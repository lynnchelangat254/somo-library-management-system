...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='user',
            name='gender',
            field=models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], default=True, max_length=255, verbose_name='Gender'),
        ...
        migrations.AlterField(
            model_name='user',
            name='phone_number',
            field=models.CharField(max_length=17, validators=[apps.utils.helper.validate_phone_number], verbose_name='Phone number'),
        ),
    ]
